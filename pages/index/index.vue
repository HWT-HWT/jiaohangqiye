		...
		<view class="announcement">
			...
			<view class="announcement-box">
				<view class="announcement-text">
					<view v-if="!this.account == ''">
						<uni-tag text="公告"
							custom-style="background-color: #feeeaf; border-color: #feeeaf; color:#dada34;"
							style="font-weight: bold;" size='small'></uni-tag>
					</view>

					<view v-if="this.account == ''">
						<uni-tag text="通知"
							custom-style="background-color: #eaf0fe; border-color: #eaf0fe; color:#5a65dc;"
							style="font-weight: bold;" size='small'></uni-tag>
					</view>
				</view>
				<view class="announcement-title">
					<p v-if="!this.account == ''">关于交通银行部分国际业务服务收费表...</p>
					<p v-if="this.account == ''">暂无新通知</p>
				</view>
			...
			<view class="banner">
				<swiper class="swiper" circular :indicator-dots="true" :autoplay="true" indicator-color='#ccc'
				...
				<view class="mini-video">
					<view class="mini-video-box">
						<view class="mini-video-one">
							<videoVue>
								<template #image>
									<image style="width: 100%; height: 100%;" src="@/static/jiaohang/bj_2.png" mode="">
									</image>
								</template>
								<template #title>
									专家发声|我们该如何养...
						...
						<view class="mini-video-one">
							<videoVue>
								<template #image>
									<image style="width: 100%; height: 100%;" src="@/static/jiaohang/bj_3.png" mode="">
									</image>
								</template>
								<template #title>
									未来AI发展的挑战与趋势
			...
			<view class="topNavTitle" :style="{'opacity':top}">
				...
				<view class="navigation-search">
					...
					<view class="search-search">
						<uni-search-bar class="uni-mt-10" radius="50" bg-color="none" placeholder="搜索"
							clearButton="auto" cancelButton="none" />
					</view>
					<view class="search-ioc">
						<view class="ioc" v-for="(item,index) in 3" :key='item'>
							<image class="ioc-image" :src='`../../static/jiaohang/Nav_my_${index+1}.png`' mode="">
							</image>
						</view>
					</view>
				</view>
	...
	export default {
		data() {
			return {
				...
				BgImag: ['../../static/jiaohang/bg_1.png', '../../static/jiaohang/bg_8.png',
					'../../static/jiaohang/bg_9.png', '../../static/jiaohang/bg_10.png'
				],
				top: '',
				account:''
			}
