<template>
	<view class="subsidiary">
		...
		<view v-if="Istrue">
			...
			<view class="btnBox" >
				<view class="TextBox" style=" background-color: #e9eeff;  color: #6f7fcd; border: 1px solid #6f7fcd;">
					全部
				</view>
				<view class="TextBox">
					贷(收)
			...
			<view class="list">
				<view class="list-text">
					...
					<view v-else>
						...
						<br />
						<text style="color: #afafaf; font-size: 20rpx;">共0</text><text style="color: #afafaf; font-size: 20rpx; margin-left:100rpx;">共0</text>
					</view>
				</view>
			...
			<view class="Type">
				<view class="type-btnBox">
					...
					<view class="Type-btnBox-btn">
						<view class="tag" style=" background-color: #e9eeff;  color: #6f7fcd; border: 1px solid #6f7fcd;">
							全部
						</view>
						<view class="tag">
							贷(收)
		...
		data() {
			return {
				...
				datalist:[
					...
					{name:'王森林',namelist:'6217582000055633630',minititle:'',money:'-￥300,000.00',time:'2024-05-31 14:55:13'},
					{name:'',namelist:'',minititle:'手续费',money:'-￥15.00',time:'2024-05-31 14:55:13'},
					{name:'陈承帮',namelist:'6230361213005664130',minititle:'',money:'-￥499,950.00',time:'2024-05-31 14:59:37'},
					{name:'',namelist:'',minititle:'手续费',money:'-￥15.00',time:'2024-05-31 14:59:37'},
					{name:'陈伟权',namelist:'622439270002364694',minititle:'',money:'+￥60,000.00',time:'2024-06-21 17:08:51',color:'red'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥3,571.40',time:'2024-06-21 17:16:38'},
					{name:'',namelist:'',minititle:'本行个人账户成功笔数代付收费标准',money:'-￥0.70',time:'2024-06-22 06:01:34'},
					...
					{minititle:'2024网银服务年费',money:'-￥150.00',time:'2024-07-03 04:32:11'},
					{minititle:'2024网银证书服务年费,用户00002',money:'-￥75.00',time:'2024-07-03 05:22:08'},
					{minititle:'2024网银证书服务年费,用户00001',money:'-￥75.00',time:'2024-07-03 05:50:35'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥5,099.56',time:'2024-07-22 04:48:31'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥5,099.56',time:'2024-08-21 04:12:59'},
					{name:'20240922利息入账',namelist:'4411140127010100100001899',minititle:'贷款利息',money:'+￥2.00',time:'2024-09-23 00:00:00',color:'red'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥5,099.56',time:'2024-09-23 04:16:22'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥5,099.56',time:'2024-10-21 10:09:56'},
					{name:'广州伊玉贸易有限公司',namelist:'441899999903000775608',minititle:'贷款利息',money:'-￥5,099.56',time:'2024-11-21 13:44:25'},
				],
				hopeBeginTime: '',
				dateKey: '',
				Istrue:true,
